...
<section class="feature-list" aria-labelledby="what-we-make-title">
	...
	<h2 id="what-we-make-title">Apps with clear jobs</h2>
	<div class="feature-columns">
		<article>
			<h3>Utility apps</h3>
			<p>Tools that help people calculate, convert, track, plan, and finish everyday tasks.</p>
		</article>
		<article>
			<h3>Learning helpers</h3>
			<p>Interfaces that make numbers, formulas, and practical concepts easier to use in the moment.</p>
		</article>
		<article>
			<h3>Productivity companions</h3>
			<p>Small workflows that reduce friction without asking users to create an account or hand over data.</p>
		</article>
	</div>
</section>
